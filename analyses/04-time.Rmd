...
```{r, bird_years, message = FALSE, echo = FALSE, fig.cap = "Kernal density plots showing the % female specimens per species across the six largest orders of birds."}
...
```{r, mammal_years, message = FALSE, echo = FALSE, fig.cap = "Kernal density plots showing the % female specimens per species across the six largest orders of mammals"}
source(here("analyses/figure-orders.R"))
