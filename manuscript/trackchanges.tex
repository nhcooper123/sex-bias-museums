...
%DIF ADD sex-bias_revision_final.tex   Tue Sep 24 10:25:20 2019
% Preamble
%-------------------------------------------------------------------------------
...
The authors declare no competing interests\DIFdelbegin \DIFdel{.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\section{\DIFdel{Data code and materials}}%DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
%DIFDELCMD < \label{data-code-and-materials}
%DIFDELCMD < %%%
\DIFdel{Data are available from the NHM Data Portal \mbox{%DIFAUXCMD
\cite{sex-bias-data} }%DIFAUXCMD
and GBIF. 
R code is available from GitHub (https://github.com/nhcooper123/sex-bias-museums)(Zenodo DOI will be added on acceptance)}\DIFdelend .
